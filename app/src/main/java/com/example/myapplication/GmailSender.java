...
public class GmailSender extends javax.mail.Authenticator {
    ...
    public GmailSender(String user, String password) {
        ...
        Properties props = new Properties();//프로퍼티 인스턴스 생성
        props.setProperty("mail.transport.protocol", "smtp");//메일 전송 프로토콜을 smtp로 설정
        props.setProperty("mail.host", mailhost);//메일을 보내는 주체를 설정
